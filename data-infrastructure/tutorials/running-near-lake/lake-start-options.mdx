...
Also, during [the April Data Platform Community Meeting](https://github.com/near/indexers-docs/blob/main/blog/2022-05-11-community-meeting-recordx) we had a question whether we plan to add this feature to the library. We've promised to create a tutorial showing how to do it by your own. So here it is.
...
Please, ensure you've the credentials set up as described on the [Credentials](/data-infrastructure/tutorials/running-near-lake/credentials) page. Otherwise you won't be able to get the code working.
