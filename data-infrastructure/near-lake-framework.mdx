...
Events such as [FT Events](https://github.com/near/NEPs/tree/master/neps/nep-0300) and [NFT Events](https://github.com/near/NEPs/tree/master/neps/nep-0256) are constantly being written as JSON files in two AWS S3 buckets:
...
## Comparison with [NEAR Indexer Framework](/data-infrastructure/near-indexer)
...
Ease of local development | Advanced<br />(localnet is a good option, but testing on testnet/mainnet is too heavy) | **Easy**<br />(see [tutorials](./tutorials/near-lake-state-changes-indexer))
...
See [Tutorials page](./tutorials/near-lake-state-changes-indexer)
