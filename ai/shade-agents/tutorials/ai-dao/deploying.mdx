...
sidebarTitle: Deploying the AI DAO
...
- First please make sure you have all the [prerequisites from our quickstart](../../getting-started/quickstart/deploying#prerequisites).
