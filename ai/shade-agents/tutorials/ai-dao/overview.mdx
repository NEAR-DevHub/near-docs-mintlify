...
- [Shade Agents](../../getting-started/introduction) 
- [NEAR Smart Contracts](../../../../smart-contracts/what-is)
...
Continue to the [Agent Contract section](./dao-agent-contract) to get started and learn about implementing yield and resume-based agent contracts.