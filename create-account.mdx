...
If you already have a NEAR account and want to use it in another wallet or the CLI, check out our guide on [Importing a NEAR Account](/tutorials/protocol/importing-account)
...
In general, all wallets will offer similar functionality, so in theory you can choose any of them. However, know that some wallets will readily allow you to create [named accounts](/protocol/account-id#named-address) (e.g. `alice.testnet`), which are easier to remember.
...
- Fund the wallet through one of our [faucets](/faucet)
- Create your [first smart contract](/smart-contracts/quickstart)
- Build a [Web3 Application](/web3-apps/quickstart)
- Learn how to build an [Auction App from end-to-end](/tutorials/auction/0-intro)