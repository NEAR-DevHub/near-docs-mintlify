...
2. Simple sign-up: create an [account for free](/create-account), login [with socials](../web3-apps/tutorials/wallet-login) or [telegram](https://web.telegram.org/k/#@herewalletbot)
