...
Check out our tutorial on [Creating a NEAR Account](/create-account) to get started!
</Tip>
...
![Account model](/assets/docs/welcome-pages/accounts.png)

### [Account ID](/protocol/account-id)
...
### [Multiple Keys](/protocol/access-keys)
