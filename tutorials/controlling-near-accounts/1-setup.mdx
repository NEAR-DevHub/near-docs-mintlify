...
sidebarTitle: Setup controllable Near account
description: "Set up a NEAR account to be securely controlled via MPC by deriving a public key and adding it as an access key."
---
...
The next step is to create, sign and eventually send a transfer transaction on behalf of `controllable.testnet`. Continue to [the next chapter](/tutorials/controlling-near-accounts/2-transfer) to learn how.
