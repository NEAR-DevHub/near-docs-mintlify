...
- [Prepare Near account](1-setupx) to be fully controlled via MPC
- [Build a transfer transaction and get it signed](2-transfer) in a smart contract
- [Broadcast a signed transaction](2-transfer) into the network over RPC.
