...
Check more docs on [callback security](../security/callbacks#async-callbacks) and [reentrancy attacks](../security/reentrancy) to avoid common pitfalls when dealing with asynchronous calls
