...
<CardGroup cols={3}>
  ...
  <Card
    title="Counter"
    img="/assets/docs/tutorials/examples/count-on-near-banner.webp"
  ...
  <Card
    title="Guest Book"
    img="/assets/docs/tutorials/examples/guest-book.webp"
  ...
  <Card
    title="Donation"
    img="/assets/docs/tutorials/examples/donation.webp"
  ...
  <Card
    title="Coin Flip"
    img="/assets/docs/tutorials/examples/coin-flip.webp"
...
Here we are using the `--useFaucet` flag to create a new account and pre-fund it with the [testnet faucet](../../faucet)
